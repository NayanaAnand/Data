...
PREPARE_LOGGING(CPP_PRJ1_i)

CPP_PRJ1_i::CPP_PRJ1_i(const char *uuid, const char *label) :
    CPP_PRJ1_base(uuid, label)
{
    // Avoid placing constructor code here. Instead, use the "constructor" function.

}

CPP_PRJ1_i::~CPP_PRJ1_i()
{
}

void CPP_PRJ1_i::constructor()
{
    /***********************************************************************************
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void CPP_PRJ1_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &CPP_PRJ1_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &CPP_PRJ1_i::<callback method>)
        in the constructor.
        ...
        CPP_PRJ1_i::CPP_PRJ1_i(const char *uuid, const char *label) :
            CPP_PRJ1_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &CPP_PRJ1_i::scaleChanged);
            addPropertyListener(status, this, &CPP_PRJ1_i::statusChanged);
        }

        void CPP_PRJ1_i::scaleChanged(float oldValue, float newValue)
        {
            RH_DEBUG(this->_baseLog, "scaleValue changed from" << oldValue << " to " << newValue);
        }
            
        void CPP_PRJ1_i::statusChanged(const status_struct& oldValue, const status_struct& newValue)
        {
